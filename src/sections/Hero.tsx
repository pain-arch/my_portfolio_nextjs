...
export const HeroSection = () => {
  return (
    <div id="hero" className="py-32 md:py-48 lg:py-60 relative z-0 scroll-mt-16">
      <div className="pointer-events-none absolute inset-0 sm:hidden md:hidden lg:block [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
        <div
